...
function generateAllShopsDailyTotal() {
  for (var i = 0; i < coffeeShopsArray.length; i++){
    ...
    console.log(allShopsTotalDailyPoundsNeeded);
  }
}
...
//     for (j = 0; i < coffeeShopsArray.length; j++) {
//       var tempTotalHourlyPoundsAllLocations = coffeeShopsArray[i].totalHourlyPoundsNeeded;
//       allShopsTotalHourlyPoundsNeeded += tempTotalHourlyPoundsAllLocations;
//     }
//     allShopsTotalHourlyPoundsNeededArray.push(allShopsTotalHourlyPoundsNeeded);
//   }
// }
...
function generateTableBody() {
  ...
  // allShopsTotalHourlyPoundsTdEl.textContent = allShopsTotalHourlyPoundsNeededArray[i];
